...
SECTIONS = {
    ...
    "build-spec/subsystems": ("Subsystems", 5, "Build Spec"),  # nav_order within Build Spec
    "survey": ("Survey", 5, None),
    "examples": ("Examples", 6, None),
}
...
BUILDSPEC_ORDER = {
    "elite-architecture.md": 1, "logging.md": 2, "testing.md": 3, "simulation.md": 4,
}
