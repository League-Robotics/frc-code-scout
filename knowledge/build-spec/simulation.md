> **Tool-facing spec** — bundled source for the `setup-simulation` skill; kept here as the source of truth. The human-facing narrative is elite-arch Part I ch. 7 + Part II under `docs/elite-arch/`.
