...
Nav2, and the autonomous-driving stack treat managed lifecycle and health as table stakes. The
component model is the right place to fix this once — in the shared shape — instead of bolting a
special case onto each subsystem.
